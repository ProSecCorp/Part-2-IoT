...
Technologies such as \gls{6lowpan} enable IPv6 communication in these constrained environments, while the \gls{rpl}, standardized by the \gls{ietf}, provides distributed routing and topology formation.
