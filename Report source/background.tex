...
\gls{ids} approaches can be deployed directly on network nodes or at a centralized monitoring point. 
...
In this work, the \gls{ids} is based on \gls{rpl} routing information and focuses on identifying inconsistencies in the observed routing hierarchy. 
