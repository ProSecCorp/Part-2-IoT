...
\begin{itemize}
    ...
    \item \textbf{\gls{mhrof}:} considers link-quality metrics such as the \gls{etx} to compute the path cost and applies hysteresis to limit unnecessary parent changes.
\end{itemize}

In the RPL implementation considered in this work, \gls{mhrof} is used for parent selection. 
...
In particular, the hysteresis mechanism of \gls{mhrof} can delay parent changes when the new route does not provide a sufficiently large improvement.
